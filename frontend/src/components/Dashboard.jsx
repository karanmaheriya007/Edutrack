          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 xl:gap-8">
            ...
            <div className="bg-white shadow-sm rounded-xl p-4 flex flex-col gap-8">
              <div className="flex items-start justify-between">
                ...
                <img src="/src/assets/images/users.svg" alt="Users" />
              </div>
              <div className="flex items-center text-base text-[#606060] font-semibold">
                <img src="/src/assets/images/up.svg" alt="Up" className="w-5 h-5 mr-3" />
            ...
            <div className="bg-white shadow-sm rounded-xl p-4 flex flex-col gap-8">
              <div className="flex items-start justify-between">
                ...
                <img src="/src/assets/images/graph.svg" alt="Graph" />
              </div>
              <div className="flex items-center text-base text-[#606060] font-semibold">
                <img src="/src/assets/images/down.svg" alt="Down" className="w-5 h-5 mr-3" />
            ...
            <div className="bg-white shadow-sm rounded-xl p-4 flex flex-col gap-8">
              <div className="flex items-start justify-between">
                ...
                <img src="/src/assets/images/time.svg" alt="Timing" />
              </div>
              <div className="flex items-center text-base text-[#606060] font-semibold">
                <img src="/src/assets/images/up.svg" alt="Up" className="w-5 h-5 mr-3" />
